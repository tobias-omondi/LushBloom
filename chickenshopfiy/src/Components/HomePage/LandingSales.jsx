...
const LandingSales = ({Title, Description}) => {
  return (
    <div className='bg-orange-500 w-full rounded-t-4xl p-4 md:p-10'>
      <div>
        <h1 className='text-white text-3xl md:text-5xl py-2 md:py-5 font-bold'>The one chicken behind it all</h1>
        <h3 className='text-gray-900 py-4 md:py-3 text-xl md:text-4xl'>Sell online and in person. Sell fresh or Frozen.<span className='cursor-pointer hover:text-gray-700'>sell locally and nationwide.</span> <br/> <span className='cursor-pointer hover:text-gray-700'>Sell direct or wholesale.</span><span className='cursor-pointer hover:text-gray-600'> Sell on mobile or desktop.</span></h3>
      </div>
